...
export class HttpService {
   ...
   *@ignore
   */
  constructor(private _http: HttpClient, private localStorage: LocalStroageService) {
  }
  ...
  patch(url: string, model: any): Observable<any> {
    return this._http.patch<any>(environment.apiBaseUrl + url, model, this.httpOptions);
  }
