...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["welcome-welcome-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTabsWelcomeWelcomePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsWelcomeWelcomeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsWelcomeWelcomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsWelcomeWelcomePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTabsWelcomeWelcomePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var WelcomePage = /*#__PURE__*/function () {
      function WelcomePage(navctrl, localStorage, statusbar, userService) {
        var _this = this;
        ...
        userService.getUserData().subscribe(function (res) {
          // this.user = res
          // console.log(res);
          userService.getUserDataById(res.id).subscribe(function (res) {
            _this.user = res;
            if (res.userType == "storeoperator") _this.navctrl.navigateForward('/storelist');
