...
const routes = [
    ...
    {
        path: 'userform',
        loadChildren: () => __webpack_require__.e(/*! import() | userform-userform-module */ "userform-userform-module").then(__webpack_require__.bind(null, /*! ./userform/userform.module */ "./src/app/tabs/profile/userform/userform.module.ts")).then(m => m.UserformPageModule)
    },
    {
        path: 'notificationsetting',
        loadChildren: () => __webpack_require__.e(/*! import() | notificationsetting-notificationsetting-module */ "notificationsetting-notificationsetting-module").then(__webpack_require__.bind(null, /*! ./notificationsetting/notificationsetting.module */ "./src/app/tabs/profile/notificationsetting/notificationsetting.module.ts")).then(m => m.NotificationsettingPageModule)
    }
];
...
let ProfilePage = class ProfilePage {
    constructor(localStorage, navctrl, userService) {
