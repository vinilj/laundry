...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["registration-login-login-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppRegistrationLoginLoginPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRegistrationLoginLoginRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRegistrationLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRegistrationLoginLoginPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRegistrationLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ionic_native_ble_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @ionic-native/ble/ngx */
    "./node_modules/@ionic-native/ble/__ivy_ngcc__/ngx/index.js"); // import { BluetoothSerial } from '@ionic-native/bluetooth-serial';


    var LoginPage = /*#__PURE__*/function () {
      function LoginPage( // private bluetoothSerial: BluetoothSerial,
      ...
      _createClass(LoginPage, [{
        ...
        value: function generateOTP() {
          ...
          if (this.phoneNumber > 999999999 && this.checkedPrivacy) this.userService.userSignup({
            ...
            _this.navctrl.navigateForward('otp', navigationExtras);
          });else if (!this.checkedPrivacy) this.toasterService.toastFail('Please check the terms & conditions');else this.toasterService.toastFail('Please enter a valid phone number');
        }
        ...
        value: function scan() {
          ...
          this.ble.scan([], 5).subscribe(function (device) {
            return _this2.onDeviceDiscovered(device);
          });
        }
      }, {
        ...
        value: function onDeviceDiscovered(device) {
          ...
          this.ngZone.run(function () {
            if (device.name == 'MyESP32') _this3.devices.push(device);
          });
        }
        ...
        value: function connect(device) {
          ...
          this.ble.connect(device.id).subscribe(function (data) {
            _this4.ble.write(device.id, data.characteristics[data.characteristics.length - 1].service, data.characteristics[data.characteristics.length - 1].characteristic, buf).then(function (data) {
              console.log(data);

              _this4.ble.disconnect(device.id);
            });
          });
        }
      }]);
    ...
    LoginPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/registration/login/login.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./login.page.scss */
      "./src/app/registration/login/login.page.scss"))["default"]]
...
//# sourceMappingURL=registration-login-login-module-es5.js.map