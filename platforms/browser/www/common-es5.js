...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppCommonApilayerAPIsOrderapiServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OrderapiService", function () {
    ...
    var OrderapiService = /*#__PURE__*/function () {
      function OrderapiService(localStorage, httpService) {
        _classCallCheck(this, OrderapiService);

        this.localStorage = localStorage;
        this.httpService = httpService;
      }

      _createClass(OrderapiService, [{
        ...
        value: function getUserIdFromStorage() {
          ...
          return this.localStorage.getStoredKey('user').then(function (user) {
            ...
            if (user.franchiseId) _this.franchiseId = user.franchiseId;
            console.log(user);
          });
        }
        /*** For User Login
        *@param{"email": "useremail","password": "string"}*/
        ...
        value: function createOrder(order) {
          var payload = {
            startTime: moment__WEBPACK_IMPORTED_MODULE_4__(),
            endTime: moment__WEBPACK_IMPORTED_MODULE_4__().add(30, "minute"),
            weight: order.weight,
            amount: order.amount,
          ...
          console.log('PayLoad', payload); // let payload = {
          //   startTime: moment(),
          //   endTime: moment(),
          //   weight: order.weight,
          //   amount: order.amount,
        ...
        key: "createDropOrder",
        value: function createDropOrder(order) {
          // let payload = {
          //   startTime: moment(),
          //   endTime: moment(),
          //   weight: order.weight,
        ...
        key: "getDropOrder",
        value: function getDropOrder(franchiseId) {
          return this.httpService.get('franchises/' + franchiseId + '/orders');
        }
      }, {
        key: "getDropOrderById",
        value: function getDropOrderById(id) {
        ...
        key: "getmachineById",
        value: function getmachineById(mId) {
          return this.httpService.get('machines/' + mId);
        }
      }, {
        key: "getInstantCoupon",
        value: function getInstantCoupon(couponCode) {
    ...
    OrderapiService.ctorParameters = function () {
      return [{
    ...
    OrderapiService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_service_localstorage_local_stroage_service__WEBPACK_IMPORTED_MODULE_3__["LocalStroageService"], _http_header_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"]])], OrderapiService);
    /***/
  },
  ...
  /***/
  function srcAppCommonServicePaymentPaymentServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var PaymentService = /*#__PURE__*/function () {
      function PaymentService(toast) {
        ...
        this.razor_key = 'rzp_test_rRvE0JzWWGkqh1';
      }
      ...
      _createClass(PaymentService, [{
        ...
        key: "payWithRazor",
        value: function payWithRazor(user) {
          var options = {
    ...
    PaymentService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_toast_toast_service__WEBPACK_IMPORTED_MODULE_2__["ToastService"]])], PaymentService);
    /***/
  }
}]);
